...
namespace MvcPL.Providers
{
    public class CustomMembershipProvider : MembershipProvider
        ...
        public MembershipUser CreateUser(string firstname,string lastname,string username,string email, string password)
        {
            ...
            var user = new UserEntity()
            {
                ...
                UserName = username,
                Email = email,
                AccountImage = "/Content/Images/accountImagePhoto.jpg",
